...
const TrainerBooked = () => {
  ...
  const trainerName = "Trainer Name Placeholder"; 
  // তুমি চাইলে backend থেকে axios দিয়ে trainer details ফেচ করতে পারো।
  ...
  const handleJoinNow = () => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        navigate(`/payment?plan=${encodeURIComponent(selectedPlan)}&slot=${encodeURIComponent(slot)}`);
      }
    });
  };
